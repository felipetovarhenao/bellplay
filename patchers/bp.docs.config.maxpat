...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "text", "remove", "icon", "minus-icon.svg", "active", 0 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 235.0, 1008.0, 92.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"args" : [ "active", 0, "text", "open", "icon", "open-icon.svg" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 318.0, 1467.5, 100.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 547.0, 585.5, 100.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 154.0, 558.0, 145.0, 22.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 437.0, 585.5, 100.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 558.0, 145.0, 22.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 81.0, 370.5, 95.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 154.0, 534.0, 145.0, 22.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 192.0, 251.0, 100.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 582.0, 145.0, 22.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 35.0, 91.0, 820.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 47.0, 792.0, 23.0 ],
					"text" : "Set the default behavior of bellplay~, including specifying .bell files to automatically run when bellplay~ is launched."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 905.0, 56.0, 170.0, 5.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.5, 72.0, 791.0, 5.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 8.0, 161.5, 791.0, 5.0 ],
					"saved_attribute_attributes" : 					{
						"linecolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2006.0, 1048.0, 71.0, 23.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2110.0, 1000.0, 112.0, 23.0 ],
					"text" : "Alarm sound muted"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2006.0, 963.0, 210.0, 23.0 ],
					"text" : "An alarm will sound when errors occur"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 2006.0, 924.0, 227.0, 23.0 ],
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 1887.0, 884.0, 137.600013613700867, 23.0 ],
					"text" : "t i i"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2006.0, 1084.0, 207.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 301.0, 131.0, 291.0, 21.0 ],
					"style" : "bellplay-gui",
					"text" : "An alarm will sound when errors occur",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1811.0, 806.0, 56.0, 23.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1887.0, 806.0, 645.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1887.0, 924.0, 41.0, 23.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1887.0, 850.0, 297.0, 23.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"versionnumber" : 80300
					}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1887.0, 768.0, 142.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 132.0, 152.0, 18.0 ],
					"text" : "mute error alerts",
					"textjustification" : 0,
					"texton" : "unmute error alerts",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1696.0, 350.0, 115.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2003.0, 475.0, 203.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 301.0, 108.0, 287.0, 21.0 ],
					"style" : "bellplay-gui",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1696.0, 229.0, 598.0, 23.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"versionnumber" : 80300
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 1696.0, 191.0, 90.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1696.0, 153.0, 165.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 87.0, 152.0, 18.0 ],
					"text" : "default tutorials folder",
					"textjustification" : 0,
					"textoncolor" : [ 0.588235294117647, 0.588235294117647, 0.588235294117647, 1.0 ],
					"textovercolor" : [ 0.56078431372549, 0.709803921568627, 0.843137254901961, 1.0 ],
					"usetextovercolor" : 1
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1696.0, 428.0, 184.0, 35.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 301.0, 85.0, 288.0, 21.0 ],
					"style" : "bellplay-gui",
					"text" : "/Users/felipetovarhenao/Documents",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1696.0, 388.0, 71.0, 23.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 1696.0, 309.0, 129.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1635.0, 229.0, 56.0, 23.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1696.0, 270.0, 303.0, 23.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"versionnumber" : 80300
					}
...
,
					"patching_rect" : [ 2003.0, 435.0, 71.0, 23.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Lato",
						"style" : "bellplay-gui"
					}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 2003.0, 396.0, 142.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 110.0, 152.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1332.600013613700867, 769.0, 89.0, 23.0 ],
					"text" : "routepass bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 192.0, 630.5, 69.0, 23.0 ],
					"text" : "t getcheck l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 192.0, 462.5, 74.0, 23.0 ],
					"text" : "bach.change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 535.0, 1432.0, 29.5, 23.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 535.0, 1395.0, 57.0, 23.0 ],
					"text" : "active $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 535.0, 1357.0, 29.5, 23.0 ],
					"text" : "> 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 535.0, 1321.0, 70.0, 23.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80300
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 430.0, 1287.0, 124.0, 23.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 318.0, 1246.0, 102.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 35.0, 68.0, 625.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 302.0, 168.5, 93.0, 21.0 ],
					"style" : "bellplay-gui",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 35.0, 128.0, 625.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 168.5, 70.0, 21.0 ],
					"style" : "bellplay-gui",
					"text" : "user imports"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1554.600013613700867, 900.0, 57.0, 23.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80300
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 235.0, 1050.0, 275.800003826618195, 23.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1555.600013613700867, 857.0, 91.200027227401733, 23.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80300
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 318.0, 1514.0, 158.400002360343933, 23.0 ],
					"text" : "t l b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 430.0, 1229.0, 293.0, 23.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"versionnumber" : 80300
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 319.0, 1602.0, 98.0, 23.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80300
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 319.0, 1640.0, 81.0, 23.0 ],
					"text" : "read $1, open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "int" ],
					"patching_rect" : [ 319.0, 1679.0, 40.0, 23.0 ],
					"text" : "text"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 319.0, 1561.0, 130.0, 23.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"versionnumber" : 80300
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 235.0, 1202.0, 126.0, 23.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"versionnumber" : 80300
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 342.0, 1162.0, 107.0, 23.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 1116.0, 806.0, 115.0, 23.0 ],
					"text" : "regexp [^\\\\/]*\\\\.bell"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 1554.600013613700867, 943.0, 57.0, 23.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80300
					}
,
...
, 			{
				"box" : 				{
					...
					"out" : "nnnn",
					"outlettype" : [ "", "", "", "", "bang" ],
					"patching_rect" : [ 834.0, 857.0, 215.0, 211.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 302.0, 189.0, 498.0, 415.0 ],
					"preventedit" : 1,
					"rowvpad" : 2.5,
					"showfocus" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1164.02158659696579, 994.0, 295.0, 23.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80300
					}
,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1115.80001038312912, 615.000008940696716, 343.22157621383667, 23.0 ],
					"text" : "t l b l null"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 834.0, 806.0, 249.0, 23.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80300
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 704.0, 756.0, 149.0, 23.0 ],
					"text" : "t l l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 1402.600013613700867, 806.0, 396.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1332.600013613700867, 725.0, 56.0, 23.0 ],
					"text" : "route set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1332.600013613700867, 650.20000946521759, 84.0, 23.0 ],
					"text" : "read $1, dump"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "int" ],
					"patching_rect" : [ 1332.600013613700867, 682.200009942054749, 40.0, 23.0 ],
					"text" : "text"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 35.0, 31.0, 307.0, 35.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 10.0, 307.0, 35.0 ],
					"text" : "settings",
...
, 			{
				"box" : 				{
					...
					"clickedstripcolor" : [ 0.831372549019608, 0.831372549019608, 0.831372549019608, 0.0 ],
					"clickedtextcolor" : [ 0.149019607843137, 0.149019607843137, 0.149019607843137, 1.0 ],
					"embed" : 0,
					"enclosure" : 1,
					"firsteleminllllisllllname" : 1,
					...
					"fontname" : "Lato Light",
					"fontsize" : 14.0,
					"hoverstripcolor" : [ 0.831372549019608, 0.831372549019608, 0.831372549019608, 0.0 ],
					"id" : "obj-35",
					"maxclass" : "bach.tree",
					"mode" : 2,
					"numinlets" : 1,
					...
					"out" : "nnnn",
					"outlettype" : [ "", "", "", "", "bang" ],
					"patching_rect" : [ 192.0, 756.0, 219.0, 227.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 189.0, 292.0, 343.0 ],
					"preventedit" : 1,
					"rowvpad" : 5.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1106.0, 428.0, 209.0, 23.0 ],
					"text" : "title \"bellplay~ | user-defined libraries\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1106.0, 394.0, 58.0, 23.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1106.0, 466.0, 70.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 308.0, 585.0, 115.0, 23.0 ],
					"text" : "regexp [^\\\\/]*\\\\.bell"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 192.0, 552.0, 135.0, 23.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80300
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 437.0, 630.5, 29.5, 23.0 ],
					"text" : "all"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 547.0, 630.5, 35.0, 23.0 ],
					"text" : "none"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 437.0, 680.5, 72.0, 23.0 ],
					"text" : "setcheck $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 234.0, 1816.0, 25.0, 23.0 ],
					"text" : "b 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 192.0, 505.0, 531.400003552436829, 23.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 342.0, 1007.0, 93.0, 23.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80300
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 234.0, 1741.0, 553.200002908706665, 23.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"versionnumber" : 80300
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 491.0, 1467.0, 56.0, 23.0 ],
					"text" : "getcheck"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 234.0, 1780.0, 507.0, 23.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"versionnumber" : 80300
					}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1896.5, 959.9375, 1873.399986386299133, 959.9375, 1873.399986386299133, 765.0, 1896.5, 765.0 ],
					"source" : [ "obj-77", 0 ]
				}
