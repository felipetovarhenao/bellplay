...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 86.0, 76.0, 23.0 ],
					"text" : "ears.mc.out~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 165.0, 10.0, 78.0, 23.0 ],
					"text" : "ears.mc.in~ 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 85.0, 10.0, 78.0, 23.0 ],
					"text" : "ears.mc.in~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 6.0, 48.0, 178.0, 23.0 ],
					"text" : "mc.slide~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 6.0, 10.0, 68.0, 23.0 ],
					"text" : "ears.mc.in~"
				}
