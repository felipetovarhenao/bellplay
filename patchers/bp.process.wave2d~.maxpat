...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 95.0, 76.0, 23.0 ],
					"text" : "ears.mc.out~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 12.0, 56.0, 262.0, 23.0 ],
					"text" : "mc.2d.wave~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 191.0, 11.0, 140.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 93.0, 11.0, 78.0, 23.0 ],
					"text" : "ears.mc.in~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 12.0, 11.0, 68.0, 23.0 ],
					"text" : "ears.mc.in~"
				}
