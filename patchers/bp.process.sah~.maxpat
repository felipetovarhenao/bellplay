...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 179.0, 11.0, 140.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 81.0, 76.0, 23.0 ],
					"text" : "ears.mc.out~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 84.0, 11.0, 78.0, 23.0 ],
					"text" : "ears.mc.in~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 8.0, 45.0, 95.0, 23.0 ],
					"text" : "mc.sah~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 8.0, 12.0, 71.0, 22.0 ],
					"text" : "ears.mc.in~"
				}
