...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.0, 387.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 64.0, 58.0, 23.0 ],
					"text" : "gate 1 #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 348.0, 84.0, 23.0 ],
					"text" : "prepend zoom"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 268.0, 51.0, 23.0 ],
					"text" : "clip -5 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 13.0, 228.0, 29.5, 23.0 ],
					"text" : "+"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 192.0, 53.0, 23.0 ],
					"text" : "pack 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 311.0, 116.0, 23.0 ],
					"text" : "expr pow(2\\, $f1 / 5.)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 47.724885702133179, 142.0, 29.5, 23.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 142.0, 29.5, 23.0 ],
					"text" : "-1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 13.0, 103.0, 88.449771404266357, 23.0 ],
					"text" : "sel 95 43"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 52.0, 22.5, 50.5, 23.0 ],
					"text" : "key"
				}
