...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 76.0, 76.0, 23.0 ],
					"text" : "ears.mc.out~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 41.0, 108.0, 23.0 ],
					"text" : "mc.log~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 94.0, 6.0, 78.0, 23.0 ],
					"text" : "ears.mc.in~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 5.0, 6.0, 68.0, 23.0 ],
					"text" : "ears.mc.in~"
				}
