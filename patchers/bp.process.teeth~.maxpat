...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 479.0, 12.0, 78.0, 23.0 ],
					"text" : "ears.mc.in~ 6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 385.0, 12.0, 78.0, 23.0 ],
					"text" : "ears.mc.in~ 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 290.0, 12.0, 78.0, 23.0 ],
					"text" : "ears.mc.in~ 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 196.0, 12.0, 78.0, 23.0 ],
					"text" : "ears.mc.in~ 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 101.0, 12.0, 78.0, 23.0 ],
					"text" : "ears.mc.in~ 2"
				}
